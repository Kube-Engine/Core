...
namespace kF::Core
{
     ...
     */
    template<typename Type, auto AllocateFunc, auto DeallocateFunc, std::integral Range = std::size_t, typename Compare = std::less<Type>, typename CustomHeaderType = void>
